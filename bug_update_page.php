...
if( $t_show_description ) {
	...
	echo '<td colspan="5">';
	echo '<textarea class="form-control" ', helper_get_tab_index(), ' cols="80" rows="5" id="description" name="description">', $t_description_textarea, '</textarea>';
	echo '</td></tr>';
}
...
if( $t_show_steps_to_reproduce ) {
	...
	echo '<td colspan="5">';
	echo '<textarea class="form-control" ', helper_get_tab_index(), ' cols="80" rows="5" id="steps_to_reproduce" name="steps_to_reproduce">', $t_steps_to_reproduce_textarea, '</textarea>';
	echo '</td></tr>';
}
...
if( $t_show_additional_information ) {
	...
	echo '<td colspan="5">';
	echo '<textarea class="form-control" ', helper_get_tab_index(), ' cols="80" rows="5" id="additional_information" name="additional_information">', $t_additional_information_textarea, '</textarea>';
	echo '</td></tr>';
}
